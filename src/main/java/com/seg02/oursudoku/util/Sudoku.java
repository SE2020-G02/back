...
//		System.out.println("总用时：" + (System.nanoTime() - start) / 1000000.0 + "ms");
	...
	public static void main(String[] args) {
		String source = "009601740420500008060207039700009801103000205602700003570902080200006054016804300";
...
//               (Math.log(Integer.highestOneBit(testV)) / Math.log(2))+1));
	 ...
	 * @param m    行（0-8）
	 * @param n    列（0-8）
	 * @param v    候选数，如0x1F9(二进制1 1111 1001)表示候选数为1 4 5 6 7 8 9
...
//		for (int i = 0; i < source.length(); i++) {
//			int v= data[i / 9][i % 9] = 1<<source.charAt(i) - '0';
//			if(v!=0){
//				data[i / 9][i % 9] = 1 << (v - 1);
//			}
//		}
